...
USER_NAME = os.environ['USER_NAME'] # 'HardikGupta'
...
if __name__ == '__main__':
    ...
    # e.g {} and 2019-11-03T21:15:07Z for username 'HardikGupta'
    ...
    # if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user HardikGupta
